...
export default function EsimSection() {
  return (
    <section className="my-20 container mx-auto p-4 rounded-xl bg-red-100">
      <div className="relative flex h-[420px] overflow-hidden rounded-lg">
        <div
          className="
            ...
            [clip-path:polygon(0_0,54%_0,37%_100%,0%_100%)]
          "
        >
        ...
        <div
          ...
          "
        >
          <Image src={esimImage} alt="" className=" h-full ml-[20%]" />
        </div>
      </div>
    </section>
  );
